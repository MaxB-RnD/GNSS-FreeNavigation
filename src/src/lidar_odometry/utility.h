...
class ParamServer {
 public:
  ...
  ParamServer() {
    ...
    nh.param<std::string>(PROJECT_NAME + "/lidarFrame", lidarFrame,
                          "base_link");
    nh.param<std::string>(PROJECT_NAME + "/baselinkFrame", baselinkFrame,
                          "base_link");
    nh.param<std::string>(PROJECT_NAME + "/odometryFrame", odometryFrame,
                          "odom");
    ...
    nh.param<float>(PROJECT_NAME + "/loopClosureFrequency",
